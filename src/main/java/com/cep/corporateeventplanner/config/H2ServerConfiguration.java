...
public class H2ServerConfiguration
{
    ...
    public MetricsProperties.Web.Server h2TcpServer() throws SQLException
    {
        return MetricsProperties.Web.Server.createTcpServer("-tcp", "-tcpAllowOthers", "-tcpPort", h2TcpPort).start();
    }
